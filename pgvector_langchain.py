...
from database import init_db, SessionLocal, session, engine
...
list_documents_txt = ["docs_txt_files_text_embedding_retrieval/cardano_meme_coin.txt", "docs_txt_files_text_embedding_retrieval/best_meme_coins_2024.txt", "docs_txt_files_text_embedding_retrieval/history_of_coins.txt", "docs_txt_files_text_embedding_retrieval/article.txt"]

# Use ollama to create embeddings
embeddings = OllamaEmbeddings(temperature=0) # for Lantern embeddings need to do some manipulation and set "options": {"m_embd": 1536}, doesn't work here, need to change it in the ollama native package manually at line 188 and 469 approx. /home/creditizens/voice_llm/voice_venv/lib/python3.10/site-packages/ollama/_client.py
...
def lantern_db_create_or_override(doc, collection, connection):
  lantern_db_create_or_override = Lantern.from_documents(
    embedding=embeddings,
    documents=doc,
  ...
  return lantern_db_create_or_override
...
# text_query = "What is coliving in Chikara Houses?"
